            ...
            <div class="conteudo">
              <fieldset class="remove_status">
                <p class="">
                  ...
                  <span>
                  <input type="text" placeholder="Email" value="Daniel.okamoto@gmail.com">
                  ...
                  <span>
                    <h2>Selecione as Empresas abaixo:</h2><br />
                      <input type="checkbox" checked/><label>YKPnFe </label>&nbsp;
                      <input type="checkbox" /><label>Eletricit nFe </label>&nbsp;
                      <input type="checkbox" checked/><label>Banco do Brasil </label>&nbsp;
                  ...
                  <input class="bt_save space" type="submit" value="gerar" onclick="alert('Dados alterados com sucesso.');"/>
                  </span>
                  </form>
                </p>
              </fieldset>
